...
function getDaylilyData(userData, ahsData, callback) {
  ...
  db.serialize(() => {
    db.run(
      "CREATE TABLE ahs(url, id, cultivar, image, hybridizer, year, parentage, color, branches, budcount, form, foliagetype, seedlingnum, bloomhabit, fragrance, scapeheight, bloomseason, rebloom, bloomsize, ploidy, sculpting, slug)"
